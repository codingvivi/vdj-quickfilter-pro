...
public:
	...
	static const int CONTROL_BTNS   = 3;   // check + refresh + kill
	static const int FIRST_BANK_ID  = CONTROL_BTNS; // ID_BUTTON_4 (0-indexed enum value 3)
